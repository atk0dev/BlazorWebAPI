...
namespace Repository
{
    public class TicketRepository : ITicketRepository
    {
        ...
        {
            string uri = "api/tickets?api-version=1.0";
        ...
        {
            ticket = await webApiExecuter.InvokePost("api/tickets?api-version=1.0", ticket);
        ...
        {
            await webApiExecuter.InvokeDelete($"api/tickets/{id}?api-version=1.0");
        }
    }
}
